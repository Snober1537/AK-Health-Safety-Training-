      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="section-subtitle">
            Have questions about our training programs or need assistance? Our team is here to help you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="space-y-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@akhealthsafety.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Safety Street, Health City, HC 12345</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card p-6 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-primary-100 hover:bg-primary-200 text-primary-600 rounded-full p-3 transition-colors">
